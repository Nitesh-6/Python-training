...
CONCEPT:
----------------                 MATHS                 PYTHON
int decimal            ==>  Number System    ===> Data Types: Numbers: 
                                                                        int 
                                                                        float 
                                                                        complex
                                                             : Boolean:
                                                             : String    
Set, Sequence, Matrix  ==>  Adv topics       ===> 9.Data Structures
                                                                   String, 
                                                                   List, 
                                                                   Tuple, 
                                                                   Dictionary, 
...
Sets, Sequences, Matrices                  ==> 9.Data Structures ==> List Tuple Dictionary Set
